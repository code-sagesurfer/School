...
//        holder.tv_category.setText(model.getGratituteCategory());
    ...
    class ViewHolderJournaling extends RecyclerView.ViewHolder implements PopupMenu.OnMenuItemClickListener, View.OnClickListener{
       ...
       // LottieAnimationView animation_like;
        TextView tv_gj_list_username,tv_location, tv_desc_text, tv_desc_text_Na, tv_gj_list_date, tv_like_count, tv_share_count, tv_description, tv_category, tv_title;
        ...
        private void showOptionMenu(View v) {
            ...
            try {
                Method method = popupMenu.getMenu().getClass().getDeclaredMethod("setOptionalIconsVisible",
                        boolean.class);
