    ...
    public static int getType(String type) {
        ...
        try {
            if (type != null) {
                ...
                if (type.equalsIgnoreCase("Reminder_appointment")) { //caseload
                    return 71;
                }
                if (type.equalsIgnoreCase("share_gratitude_journal")) { //share_gratitude_journal
                    return 72;
                }

                if (type.equalsIgnoreCase("share_gratitude_journal_update")) { //share_gratitude_journal_add
                    return 73;
                }

                if (type.equalsIgnoreCase("share_gratitude_journal_add")) { //share_gratitude_journal_add
                    return 74;
                }
                if (type.equalsIgnoreCase("share_gratitude_journal_delete")) { //share_gratitude_journal_add
                    return 75;
                }


                if (type.equalsIgnoreCase("share_addiction")) { //share_gratitude_journal_add
                    return 103;
                }
                //share_gratitude_journal_add
                //share_gratitude_journal_update
                //share_gratitude_journal_delete


                if (type.equalsIgnoreCase("reminder_notification_for_medicine")//
                        || type.equalsIgnoreCase("snooze_notification")
                        || type.equalsIgnoreCase("snooze_after_number")
                        || type.equalsIgnoreCase("skip_notification_for_medicine")) { //caseload
                    return 102;
                }

                if (type.equalsIgnoreCase("intake_updated")
                        || type.equalsIgnoreCase("consent_form_reminder")
                        || type.equalsIgnoreCase("consent_form")
                        || type.equalsIgnoreCase("consent_updated")
                        || type.equalsIgnoreCase("intake_form_reminder")
                        || type.equalsIgnoreCase("intake_form")) {
                    return 1103;
                }
